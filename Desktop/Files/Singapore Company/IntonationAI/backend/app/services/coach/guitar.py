...
from app.services.llm.prompts import GUITAR_COACH_PROMPT, GUITAR_COACH_RAG_SECTION
...
class GuitarCoach(BaseCoach):
    ...
    async def get_welcome_message(self) -> str:
        return (
            "Hi! I'm your AI guitar coach. Play chords or strum into the mic and I'll "
            "analyse your technique, chord clarity, and timing. Let's get started!"
        )
