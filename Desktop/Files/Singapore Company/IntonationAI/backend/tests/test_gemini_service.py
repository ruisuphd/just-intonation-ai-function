...
class TestGeminiClientTextOnly:
    ...
    @pytest.mark.asyncio
    async def test_invoke_returns_model_text(self, gemini_client_instance):
        ...
        with (
            ...
            result = await gemini_client_instance.invoke(
    ...
    @pytest.mark.asyncio
    async def test_invoke_passes_system_instruction(self, gemini_client_instance):
    ...
    @pytest.mark.asyncio
    async def test_invoke_maps_assistant_role_to_model(self, gemini_client_instance):
...
class TestGeminiClientAudioBytes:
    ...
    @pytest.mark.asyncio
    async def test_audio_bytes_appended_to_last_user_message(self, gemini_client_instance):
    ...
    @pytest.mark.asyncio
    async def test_audio_bytes_not_added_to_non_last_or_non_user_message(
