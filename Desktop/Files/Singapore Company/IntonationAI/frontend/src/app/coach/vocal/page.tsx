...
const INITIAL_MESSAGE: ChatMessage = {
  ...
  role: "coach",
  content:
    "Hello! I'm your AI vocal coach. How can I help you today? You can start singing or speaking, and I'll analyse your technique.",
  timestamp: Date.now(),
};
  ...
  return (
    ...
    <div className="flex h-[calc(100vh-3.5rem)] flex-col bg-[#fbfbfd] supports-[height:100dvh]:h-[calc(100dvh-3.5rem)]">
      <div className="flex items-center justify-between border-b border-[#d2d2d7] bg-white px-4 py-3">
        <h1 className="text-lg font-semibold text-[#1d1d1f]">Vocal Coach</h1>
      ...
      <div className="flex min-h-0 flex-1 overflow-hidden">
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden p-4 lg:flex-row lg:gap-4">
          ...
          <InsightsPanel
            ...
            suggestion="Sing a sustained note to see pitch feedback."
          />
        </div>
      </div>
